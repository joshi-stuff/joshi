...
return {
	...
	alarm: {
		args: [{ type: 'int', name: 'seconds' }],
		returns: { type: 'unsigned' },
		throws: 'nothing',
	},

	chdir: {
		args: [{ type: 'char*', name: 'path' }],
		returns: { type: 'int' },
		throws: 'errno',
	},

	close: {
		args: [{ type: 'int', name: 'fd' }],
		returns: { type: 'int' },
		throws: 'errno',
	},

	closedir: {
		args: [{ type: 'DIR*', name: 'dirp' }],
		returns: { type: 'int' },
		throws: 'errno',
	},
	...
	pipe: {
		args: [{ type: 'int[]', name: 'fildes', in_out: true }],
		returns: { type: 'int' },
		throws: 'errno',
	},
	...
	sleep: {
		args: [{ type: 'unsigned int', name: 'seconds' }],
